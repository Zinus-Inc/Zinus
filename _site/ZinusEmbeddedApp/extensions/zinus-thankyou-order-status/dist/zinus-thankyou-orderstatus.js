(() => {
  ...
  // extensions/zinus-thankyou-order-status/src/Checkout.jsx
...
${errorInfo.componentStack}`);
  ...
  function Extension() {
    ...
    const { extension: extension2, orderConfirmation } = useApi();
    const email = useEmail();
    const { orderStatusTitle, orderStatusMessage, orderStatusButton } = useSettings();
    const [link, setLink] = (0, import_react15.useState)("");
    (0, import_react15.useEffect)(() => {
      if (email) {
        setLink(`https://www.zinus.com/apps/tracktor/track?token=${modifyEmail(email)}&order=${orderConfirmation.current.number}`);
      }
    }, [email, orderConfirmation]);
    function modifyEmail(email2) {
      const splitString = email2.split("");
      const reverseArray = splitString.reverse();
      const joinArray = reverseArray.join("");
      return encodeURIComponent(joinArray.replace("@", "_-_"));
    }
    console.log("email: ", email);
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(BlockLayout2, { rows: ["auto", "fill"], children: [
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(View2, { border: "base", padding: "base", cornerRadius: ["base", "base", "none", "none"], children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Text2, { children: orderStatusTitle || translate("orderStatusTitle", { target: extension2.target }) }) }),
      /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(View2, { border: "base", padding: "base", cornerRadius: ["none", "none", "base", "base"], children: [
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Text2, { children: orderStatusMessage || translate("orderStatusMessage", { target: extension2.target }) }),
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(View2, { padding: ["base", "none"], children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Button2, { to: link, children: orderStatusButton || translate("orderStatusButton", { target: extension2.target }) }) })
      ] })
    ] });
  }
})();
//# sourceMappingURL=zinus-thankyou-orderstatus.js.map
