(() => {
  ...
  // extensions/contiguous-states-restriction/src/Checkout.jsx
...
${errorInfo.componentStack}`);
  ...
  var deliveryAddress = reactExtension("purchase.checkout.delivery-address.render-before", () => /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(ContiguousStatesBanner, {}));
  function ContiguousStatesBanner() {
    const shippingAddress = useShippingAddress();
    const restrictedLocations = ["AK", "HI", "GU", "AS", "PR", "FM", "MH", "MP", "PW", "VI", "AA", "AE", "AP"];
    useBuyerJourneyIntercept(
      () => {
        return (shippingAddress == null ? void 0 : shippingAddress.provinceCode) && restrictedLocations.includes(shippingAddress == null ? void 0 : shippingAddress.provinceCode) ? {
          behavior: "block",
...
//# sourceMappingURL=contiguous-states-restriction.js.map
