(() => {
  ...
  // extensions/zinus-checkout-customization/src/Checkout.jsx
...
${errorInfo.componentStack}`);
  ...
  var Checkout_default = cartItemExtension = reactExtension("purchase.checkout.cart-line-item.render-after", () => /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(App, {}));
  function App() {
    var _a, _b, _c;
    const extensionApi = useApi();
    const { query } = useApi();
    const deliveryGroups = useSubscription(extensionApi.deliveryGroups);
    const deliveryOptions = (_a = deliveryGroups[0]) == null ? void 0 : _a.deliveryOptions;
    const heightMetafields = useAppMetafields({ type: "product", namespace: "custom", key: "variant_title" });
    const selectedOption = (_b = deliveryGroups[0]) == null ? void 0 : _b.selectedDeliveryOption;
    const shippingMethodTitle = selectedOption && ((_c = deliveryOptions.find((opt) => opt.handle === selectedOption.handle)) == null ? void 0 : _c.title);
    const cartLineTarget = useCartLineTarget();
    const [height, setHeight] = (0, import_react12.useState)("");
    (0, import_react12.useEffect)(() => {
      var _a2, _b2;
      const productId = (_b2 = (_a2 = cartLineTarget == null ? void 0 : cartLineTarget.merchandise) == null ? void 0 : _a2.product) == null ? void 0 : _b2.id;
      query(
        `
        query {
      ...
      `
        ...
        var _a3;
        const variantMetafiledData = (_a3 = data == null ? void 0 : data.product) == null ? void 0 : _a3.variants.edges.map(
          (item) => {
            var _a4, _b3;
            if (((_a4 = item == null ? void 0 : item.node) == null ? void 0 : _a4.id) === ((_b3 = cartLineTarget == null ? void 0 : cartLineTarget.merchandise) == null ? void 0 : _b3.id))
              return item;
          }
        );
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(BlockLayout, { children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(Text2, { children: [
      "Height: ",
      height,
      '"'
    ] }) });
...
//# sourceMappingURL=zinus-checkout-customization.js.map
