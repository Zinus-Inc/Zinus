(() => {
  ...
  // extensions/zinus-checkout-countdown/src/Checkout.jsx
...
${errorInfo.componentStack}`);
  ...
  function App() {
    ...
    const [timeLeft, setTimeLeft] = (0, import_react11.useState)(600);
    ...
    const title = merchantTitle != null ? merchantTitle : "Hurry!";
    const description = merchantDescription != null ? merchantDescription : "Your order is reserved for {{ timeLeft }} minutes!";
    const expiredTimer = merchantExpiredTimer != null ? merchantExpiredTimer : "Check out now to secure your items.";
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Banner2, { title, status, collapsible, children: getMinutes(timeLeft) === 0 && (getSeconds(timeLeft) === 0 || getSeconds(timeLeft) === "00") ? expiredTimer : description.replace("{{ timeLeft }}", getTimeLeft(timeLeft)) });
  }
})();
//# sourceMappingURL=checkout-countdown-timer.js.map
