(() => {
  ...
  // extensions/zinus-thank-you-form/src/Checkout.jsx
...
${errorInfo.componentStack}`);
  ...
  var thankYouBlock = reactExtension("purchase.checkout.block.render", () => /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Attribution, {}));
  function Attribution() {
    const lines = useCartLines([]);
    const updateAttribute = useApplyAttributeChange();
    const attributes = useAttributes();
    const shippingAddress = useShippingAddress();
    const [qualifyingItems, setQualifyingItems] = (0, import_react14.useState)(false);
    ...
    (0, import_react14.useEffect)(() => {
      for (const line of lines) {
        if (line.merchandise.product.productType === "mattress" || line.merchandise.product.productType === "Box Spring") {
          console.log("qualifying item(s) found");
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(import_jsx_runtime4.Fragment, { children: feeLocations.includes(shippingAddress.provinceCode) && qualifyingItems ? /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(BlockStack2, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Heading2, { children: "Add Pick Up" }),
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Text2, { size: "medium", children: "Free Pickup Request" }),
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Checkbox2, { id: "checkbox", name: "checkout[attribute][Pickup Requested]", onChange: (checked) => handleCheckboxClicked(checked, this), children: "I will require removal of my old mattress/box spring from my delivery address." })
    ] }) : /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(import_jsx_runtime4.Fragment, {}) });
  }
})();
//# sourceMappingURL=zinus-thank-you-form.js.map
