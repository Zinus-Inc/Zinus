...
This report summarizes the status of **190 website development Jira tickets** for Zinus during October 2025 (5th week), covering both Helixian and Zinus projects with a focus on website-related tasks.

- Ticket Types:
  - **Tasks:** 183
  - **Bugs:** 3
  - **No other types detected**
- Completion Rate:
  - **Done:** 9 tickets (~4.7%)
  - **In Progress / Final Client QA / Reviewing / Ready For QA:** 15 tickets (~7.9%)
  - **On Hold:** 31 tickets (~16.3%)
  - **To Do:** Majority (~71%)
- Major themes:
  - Extensive **accessibility improvements (ADA/WCAG compliance)** across site components, especially carousels, modals, and product pages.
  - **Search and tagging enhancements** for Shopify analytics and reports.
  - Planned **FAQ and support content expansions** including assembly instruction search.
  - Planning and investigation tasks related to **server-side analytics tracking and domain migration**.
- Bug tickets focus on:
  - Google Search Console issues affecting rich snippet eligibility.
  - Slow loading and responsiveness issues in checkout Shipping Protection UI.
  - Homepage and product page UI alignment and performance problems.
- Bug Fix Summary:
  - These bugs remain open or on hold, pending fixes for rich snippet schema, checkout performance optimization, and UI layout alignment.
...
|--------------------|--------------------------------------------------------------------------|------------------------------------------------|
| Google Rich Snippets | 99% of product items not eligible for Google rich results due to missing schema fields | Reduced Search Engine visibility & SEO ranking |
| Checkout Page       | Slow loading and lag in Shipping Protection toggle during checkout       | Checkout interruption risk, potential drop-off |
| Homepage & PDP UI   | Multiple UI alignment issues and slow loading on homepage and product pages | Degraded user experience and conversion rates  |

### Business Impact
- SEO ranking and CTR may be adversely affected by missing rich snippets.
- Potential loss of customers due to slow checkout interactions.
- Poor site usability reducing overall conversion rates.
...
|----------------|----------------------------------------------------------------------|---------------------------------|
| Rich Snippet Schema | Investigation ongoing; added tasks to implement JSON-LD structured data for reviews | ⏳ Fix pending implementation     |
| Checkout UI    | Performance investigations underway for Shipping Protection component | ⏳ Action plan under development |
| Homepage & PDP | UI alignment and performance issues under review by development team | ⏳ Work scheduled / ongoing      |
...
|----------------------------|---------------------------------------------------------------|---------------------------------------------------------|
| FAQ Section (Planned)      | No centralized, channel-aware FAQ on Zinus.com                | Planned Shopify-native FAQ with AI/SEO readiness and channel separation |
| Search Relevance           | Pillow keyword search returned less relevant bed frame results | Planned reordering to prioritize exact pillow SKUs and related bundles |
| Shopify Product Schema     | Inconsistent metafield usage and partial SEO tags             | Ongoing audit to create remediation plan for schema uniformity and SEO improvements |
| Load Performance           | Slow responses on checkout's Shipping Protection toggle       | Performance review in progress for smoother toggle interaction |
| Accessibility Compliance   | Multiple ARIA and heading markup issues sitewide               | Remediation task backlog created; fixes planned for keyboard focus, ARIA attributes, and color contrasts |
...
|-----------------|-------------------------------------------------------------|---------------------------------------------|-----------------|
| Helixian-ZIN-1253 | Support/FAQ expansion and Assembly Instruction Search page  | Finalize design and confirm MVP scope       | Daniel Carroll  |
| Helixian-ZIN-1177 | Google Search Console rich snippet low eligibility issue     | Implement JSON-LD per Bazaarvoice guidelines| Daniel Carroll  |
| Helixian-ZIN-1072 | Slow loading at checkout Shipping Protection toggle          | Apply performance profiling and optimization| Daniel Carroll  |
| Helixian-ZADA-959 | Homepage and PDP UI alignment and performance issues         | Prioritize fixing high-priority visual bugs | Yongwan Song    |
| Zinus-ZIN-31      | Fix missing tags in Shopify page type and traffic source data| Continue tag mapping and data validation    | Mason Kim       |
| Helixian-ZADA-638 | Unnecessary ARIA attributes causing screen reader problems   | Review and remove incorrect ARIA attributes| Accessibility Team |
| Helixian-ZADA-434 | Image links missing appropriate labeling for screen readers  | Remediate alt text and ARIA labels          | Tony Yen        |
...
Task|Helixian-ZIN-1252|Deployment|Done|Daniel Carroll|Daniel Carroll|2025-10-28T09:41:58.907-0500|Done|
...
Task|Helixian-ZIN-1115|BI Reporting App|Done|Daniel Carroll|Bill Dzadon|2025-08-21T09:54:26.902-0500|Done|
...
Task|Helixian-ZIN-1032|Investigate & Resolve Bing Ads ↔ Shopify Attribution Discrepancy|Done|Bobby Hudgins|Mason Kim|2025-06-05T13:06:57.306-0500|Done|
...
Task|Zinus-ZIN-8|Replace RPA-Based BI Data Extraction System with API Integration Framework|Done|Mason Kim|Mason Kim|2025-10-19T18:24:41.859-0400|Done|
...
Task|Helixian-ZADA-482|Elements that function as buttons must be marked up as such so that screen reader users will identify them as actionable and they will be usable by keyboard users.|Ready For Allyant QA|Bobby Hudgins|Daniel Carroll|2025-03-12T09:55:36.100-0500|Done|
Task|Helixian-ZADA-462|Text within images causes problems for screen reader users and users of magnification technology.|Ready For Allyant QA|Bobby Hudgins|Daniel Carroll|2025-03-12T09:53:59.298-0500|Done|
...
Task|Helixian-ZADA-363|Information that is only provided visually must be conveyed to screen reader users.|Ready For Allyant QA|Bobby Hudgins|Daniel Carroll|2025-03-12T09:46:00.327-0500|Done|
...
Task|Helixian-ZADA-347|Alt attribute text for decorative images is redundant and/or unnecessary.|Ready For Allyant QA|Bobby Hudgins|Daniel Carroll|2025-03-12T09:44:36.398-0500|Done|
...
Task|Helixian-ZADA-314|It is not clear to screen reader users where the carousel begins or ends.|Ready For Allyant QA|Bobby Hudgins|Daniel Carroll|2025-03-12T09:41:58.435-0500|Done|
...
Task|Helixian-ZADA-271|Selection of an item causes the page to refresh before the focus leaves the control. Most users would not expect a form submission without actively selecting a submit button.|Done|Bobby Hudgins|Daniel Carroll|2025-03-12T09:38:18.446-0500|Done|
...
Task|Helixian-ZADA-231|Elements that are marked up as links but function as buttons can cause confusion for screen reader users.|Ready For Allyant QA|Bobby Hudgins|Daniel Carroll|2025-03-12T09:34:56.684-0500|Done|
...
Task|Helixian-ZADA-144|Additional content is only revealed on hover, which is inaccessible to screen reader and keyboard users.|Ready For Allyant QA|Bobby Hudgins|Daniel Carroll|2025-03-12T09:28:50.010-0500|Done|
...
> Report coverage: 2025-10-28 to 2025-11-03